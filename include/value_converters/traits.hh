...
template <typename T,
          typename = std::enable_if<
              ...
              std::is_same_v<T, uint32_t> || std::is_same_v<T, int64_t> || std::is_same_v<T, float> ||
              std::is_same_v<T, double> || std::is_same_v<T, std::string> || std::is_same_v<T, CassCollection *>>>
...
template <typename T, typename = std::enable_if<std::is_same_v<T, int8_t> || std::is_same_v<T, int16_t> ||
